...
//                                      = 758, not used
    ...
    LANG_ANNOUNCE_GUARD_KILLED_BY_A     = 50007,
    LANG_ANNOUNCE_GUARD_KILLED_BY_H     = 50008,
    LANG_ANNOUNCE_LEVEL_A               = 50009,
    LANG_ANNOUNCE_LEVEL_H               = 50010,
    LANG_ANNOUNCE_CREATURE_APPEAR       = 50011,
    LANG_ANNOUNCE_GUILD_CREATED_A       = 50012,
    LANG_ANNOUNCE_GUILD_CREATED_H       = 50013,
    LANG_ANNOUNCE_ZONE_PLAYERS_INFO     = 50014,
    LANG_ANNOUNCE_PROFESSION_SKILL_300  = 50015,

    LANG_REALM_CHAT_ERROR_LEVEL         = 50016,
    LANG_REALM_CHAT_ERROR_COOLDOWN      = 50017,
    LANG_REALM_CHAT_MESSAGE             = 50018
};
#endif
